...
const COMMENTS: SeedComment[] = [
  {
    author: "yousuf.alamri@tielora.example",
  ...
  {
    author: "layla.alriyami@tielora.example",
    disciplineTask: "Civil foundation load check",
    ...
    mentions: ["yousuf.alamri@tielora.example"],
  },
  {
    author: "yousuf.alamri@tielora.example",
    disciplineTask: "Civil foundation load check",
  ...
  {
    author: "john.carter@tielora.example",
  ...
  {
    author: "aisha.alkindi@tielora.example",
  ...
  {
    author: "omar.alhabsi@tielora.example",
    disciplineTask: "Inspection release certificates collected",
    ...
    mentions: ["aisha.alkindi@tielora.example"],
  },
  {
    author: "ahmed.albalushi@tielora.example",
  ...
  {
    author: "priya.nair@tielora.example",
  ...
  {
    author: "daniel.okoro@tielora.example",
    disciplineTask: "Vibration monitoring scope reviewed",
    ...
    mentions: ["priya.nair@tielora.example"],
  },
  {
    author: "maria.santos@tielora.example",
  ...
  {
    author: "salim.alhinai@tielora.example",
